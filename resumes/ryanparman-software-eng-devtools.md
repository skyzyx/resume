...
CI/CD, CLI tools, [AWS], [Bash], [CircleCI], [Docker], [GitHub Actions], [Git], [Go], [GraphQL], [JWT], [JavaScript], [PHP], [Python], [Redis], [Vagrant], [XSLT], [twelve-factor applications], automation, code generation, containerization, debugging, development, distributed, documentation, integration, microservices, multi-platform, optimization, performance, platforms, refactoring, scalability, security, standards, test-driven development, testing.
